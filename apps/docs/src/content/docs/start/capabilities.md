...
Run capability probes and export preflight on the actual device and with representative media. See [compatibility and deployment](/AelionSDK/zh/production/compatibility/) and the [performance baseline](/AelionSDK/zh/production/performance/).
