      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Revision 持久化与扩展隔离', slug: 'guides/durability-extensions' },
            { label: '从 WebAV 与 Diffusion Studio 迁移', slug: 'guides/migration' },
            { label: '音频分析、静音移除与母带', slug: 'guides/audio-mastering' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'WebAV 与 Diffusion 同机基准', slug: 'production/competitor-benchmark' },
