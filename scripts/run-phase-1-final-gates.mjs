...
const gates = [
  ...
  [
    ...
    corepackExecutable,
    corepackArguments(['pnpm', 'test:browser:webkit']),
  ],
  [
    'corepack pnpm test:browser:mobile',
    corepackExecutable,
    corepackArguments(['pnpm', 'test:browser:mobile']),
  ],
  ['corepack pnpm test:golden', corepackExecutable, corepackArguments(['pnpm', 'test:golden'])],
  ['corepack pnpm test:security', corepackExecutable, corepackArguments(['pnpm', 'test:security'])],
  ['corepack pnpm test:soak', corepackExecutable, corepackArguments(['pnpm', 'test:soak'])],
