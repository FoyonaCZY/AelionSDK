...
**Documentation:** [English](https://foyonaczy.github.io/AelionSDK/) · [简体中文](https://foyonaczy.github.io/AelionSDK/zh/)

AelionSDK is framework-agnostic: React, Vue, Svelte and plain DOM applications can use the same public APIs. The engine keeps a canonical Project model and Render IR shared by preview and export, so timeline edits, materials, audio and output stay deterministic.

## What it provides

- Timeline editing with transactions, revisions, undo/redo, markers, linked A/V items and nested sequences.
- Canvas preview and playback with WebGL2/WebGPU worker compositing and AudioWorklet timing.
- Browser media indexing, VideoFrame/PCM decoding, HTTP Range access, proxy assets and cache budgets.
- H.264/AV1/HEVC + AAC MP4, VP9/Opus WebM, image/GIF and WAV/RF64 export with capability preflight.
- Persisted Project snapshots, IndexedDB recovery, custom Materials, Worker RPC and remote export providers.
