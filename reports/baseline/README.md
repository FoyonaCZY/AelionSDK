...
验证环境为 Node.js `v20.20.2`、pnpm `10.13.1`、macOS `15.6.1` x64。首次提交前仓库没有 Git HEAD，因此报告保存 workspace manifest，而不伪造 commit。当前产品结论和证据地图见[项目状态](../../apps/docs/src/content/docs/zh/project/status.md)。
