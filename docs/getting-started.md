...
完整 File→Project→Canvas→H.264 示例由 CI 编译：[`examples/typescript/sdk-integration.ts`](../examples/typescript/sdk-integration.ts)。可运行参考编辑器位于 [`apps/editor-demo`](../apps/editor-demo)，只从公开包入口导入。
