...
`aelionRuntimeAssetUrls('https://cdn.example/sdk/1.2.0-rc.3/')`; keep application modules and all four
...
This package is part of [AelionSDK](https://github.com/FoyonaCZY/AelionSDK). The `1.2.0-rc.3` API may change before the first stable release.
